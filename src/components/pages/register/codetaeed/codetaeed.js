...
const Codetaeed=(props)=>{
  ...
  const reset=()=>{
    ...
    <Dropdown3 /> 
      ...
      <text  style={{marginTop:10,marginBottom:20,display:'block'}}>کدتایید برای شماره همراه واردشده ارسال شد</text> 
      <a className="textcodtaeed" >ویرایش شماره همراه</a>
      <div className="errorresetpassword" style={{display:errors.length<1?'none':'',}}>
      {errors}
      </div>
     
      <input type="email" placeholder="کد تایید را وارد کنید" onChange={mail} />
      ...
      <text style={{color:'gray',display:'block',marginTop:20}}>برای ارسال مجدد کد تایید کلیک کنید</text>
    ...
    export default withRouter(Codetaeed) ;